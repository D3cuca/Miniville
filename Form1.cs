...
namespace MiniVille
{
    public partial class Form1 : Form
    {
        //Declare Components
            ...
            DiceManager DManager = new DiceManager();
    ...
    Expert, Normal, StartBttn);
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            while (i < 20)
            {
                ...
                PictureDice1.Image = DManager.ChooseImage(dice1);
                PictureDice2.Image = DManager.ChooseImage(dice2);
...
Expert, Normal, StartBttn);
        ...
        {
            //Checks if there are cards available and changes it's visibility
